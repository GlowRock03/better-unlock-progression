...
class MoonPage : public CCObject {
private:
...
public:
    MoonPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("100", 26, IconType::Swing); unlockData1->autorelease();
        unlockData2 = new UnlockData("200", 3, IconType::Jetpack); unlockData2->autorelease();
        unlockData3 = new UnlockData("300", 86, "main"); unlockData3->autorelease();
        unlockData4 = new UnlockData("400", 207, IconType::Cube); unlockData4->autorelease();
        unlockData5 = new UnlockData("500", 38, IconType::Ufo); unlockData5->autorelease();
        unlockData6 = new UnlockData("600", 111, IconType::Ball); unlockData6->autorelease();
        unlockData7 = new UnlockData("700", 65, "secondary"); unlockData7->autorelease();
        unlockData8 = new UnlockData("800", 158, IconType::Cube); unlockData8->autorelease();
        unlockData9 = new UnlockData("900", 38, IconType::Robot); unlockData9->autorelease();
        unlockData10 = new UnlockData("1000", 21, IconType::Swing); unlockData10->autorelease();

        unlockData11 = new UnlockData("1500", 199, IconType::Cube); unlockData11->autorelease();
        unlockData12 = new UnlockData("2000", 94, IconType::Ball); unlockData12->autorelease();
        unlockData13 = new UnlockData("2500", 4, IconType::Jetpack); unlockData13->autorelease();
        unlockData14 = new UnlockData("3000", 91, "main"); unlockData14->autorelease();
        unlockData15 = new UnlockData("3500", 70, IconType::Ship); unlockData15->autorelease();
        unlockData16 = new UnlockData("4000", 268, IconType::Cube); unlockData16->autorelease();
        unlockData17 = new UnlockData("4500", 41, IconType::Wave); unlockData17->autorelease();
        unlockData18 = new UnlockData("5000", 39, IconType::Spider); unlockData18->autorelease();
        unlockData19 = new UnlockData("5500", 144, IconType::Ufo); unlockData19->autorelease();
        unlockData20 = new UnlockData("6000", 108, IconType::Ball); unlockData20->autorelease();

        unlockData21 = new UnlockData("6500", 457, IconType::Cube); unlockData21->autorelease();
        unlockData22 = new UnlockData("7000", 75, IconType::Ufo); unlockData22->autorelease();
        unlockData23 = new UnlockData("7500", 118, IconType::Ball); unlockData23->autorelease();
        unlockData24 = new UnlockData("8000", 105, IconType::Ship); unlockData24->autorelease();
        unlockData25 = new UnlockData("9000", 38, IconType::Swing); unlockData25->autorelease();
        unlockData26 = new UnlockData("10000", 62, IconType::Ball); unlockData26->autorelease();
    }

    CCNode* createMoonPage(int moons) {
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(MoonPage::onTierButton)
        );
    ...
    CCNode* createTier1(int moons) {
        ...
        float ratio1 = (float)(moons - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(moons - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(moons - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(moons - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(moons - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(moons - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(moons - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        auto unlockInfo7 = new UnlockInfo(unlockData7->unlockId, unlockData7->colorType);
        unlockInfo7->autorelease();
        auto unlock7 = ColorChannelSprite::create();
        ...
        float ratio8 = (float)(moons - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        float ratio9 = (float)(moons - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(moons - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  moons >= std::stoi(unlockData0->numberString) && moons < std::stoi(unlockData10->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(moons).c_str()));
        ...
        unlock7->setColor(gameManager->colorForIdx(unlockInfo7->iconId));
        if (ratio7 >= 1.f) {
        ...
        lock7->setPosition({17.75f, 18.25f});  lock7->setZOrder(1);
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(MoonPage::openUnlockInfo)
		);
    ...
    CCNode* createTier2(int moons) {
        ...
        auto sliderOutlineSpr1 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr1 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio1 = (float)(moons - std::stoi(unlockData10->numberString)) / (float)(std::stoi(unlockData11->numberString) - std::stoi(unlockData10->numberString));
        float scale1 = ratio1 >= 0.98f ? sliderBarSpr1->getContentSize().width * 0.98f : sliderBarSpr1->getContentSize().width * ratio1;
        sliderBarSpr1->setTextureRect(CCRectMake(0, 0, scale1, sliderBarSpr1->getContentSize().height));
        ...
        auto sliderOutlineSpr2 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr2 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio2 = (float)(moons - std::stoi(unlockData11->numberString)) / (float)(std::stoi(unlockData12->numberString) - std::stoi(unlockData11->numberString));
        float scale2 = ratio2 >= 0.98f ? sliderBarSpr2->getContentSize().width * 0.98f : sliderBarSpr2->getContentSize().width * ratio2;
        sliderBarSpr2->setTextureRect(CCRectMake(0, 0, scale2, sliderBarSpr2->getContentSize().height)); 
        ...
        auto sliderOutlineSpr3 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr3 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio3 = (float)(moons - std::stoi(unlockData12->numberString)) / (float)(std::stoi(unlockData13->numberString) - std::stoi(unlockData12->numberString));
        float scale3 = ratio3 >= 0.98f ? sliderBarSpr3->getContentSize().width * 0.98f : sliderBarSpr3->getContentSize().width * ratio3;
        sliderBarSpr3->setTextureRect(CCRectMake(0, 0, scale3, sliderBarSpr3->getContentSize().height));  
        ...
        auto sliderOutlineSpr4 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr4 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio4 = (float)(moons - std::stoi(unlockData13->numberString)) / (float)(std::stoi(unlockData14->numberString) - std::stoi(unlockData13->numberString));
        float scale4 = ratio4 >= 0.98f ? sliderBarSpr4->getContentSize().width * 0.98f : sliderBarSpr4->getContentSize().width * ratio4;
        sliderBarSpr4->setTextureRect(CCRectMake(0, 0, scale4, sliderBarSpr4->getContentSize().height));
        ...
        auto sliderOutlineSpr5 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr5 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio5 = (float)(moons - std::stoi(unlockData14->numberString)) / (float)(std::stoi(unlockData15->numberString) - std::stoi(unlockData14->numberString));
        float scale5 = ratio5 >= 0.98f ? sliderBarSpr5->getContentSize().width * 0.98f : sliderBarSpr5->getContentSize().width * ratio5;
        sliderBarSpr5->setTextureRect(CCRectMake(0, 0, scale5, sliderBarSpr5->getContentSize().height));
        ...
        auto sliderOutlineSpr6 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr6 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio6 = (float)(moons - std::stoi(unlockData15->numberString)) / (float)(std::stoi(unlockData16->numberString) - std::stoi(unlockData15->numberString));
        float scale6 = ratio6 >= 0.98f ? sliderBarSpr6->getContentSize().width * 0.98f : sliderBarSpr6->getContentSize().width * ratio6;
        sliderBarSpr6->setTextureRect(CCRectMake(0, 0, scale6, sliderBarSpr6->getContentSize().height));
        ...
        auto sliderOutlineSpr7 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr7 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio7 = (float)(moons - std::stoi(unlockData16->numberString)) / (float)(std::stoi(unlockData17->numberString) - std::stoi(unlockData16->numberString));
        float scale7 = ratio7 >= 0.98f ? sliderBarSpr7->getContentSize().width * 0.98f : sliderBarSpr7->getContentSize().width * ratio7;
        sliderBarSpr7->setTextureRect(CCRectMake(0, 0, scale7, sliderBarSpr7->getContentSize().height));
        ...
        auto sliderOutlineSpr8 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr8 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio8 = (float)(moons - std::stoi(unlockData17->numberString)) / (float)(std::stoi(unlockData18->numberString) - std::stoi(unlockData17->numberString));
        float scale8 = ratio8 >= 0.98f ? sliderBarSpr8->getContentSize().width * 0.98f : sliderBarSpr8->getContentSize().width * ratio8;
        sliderBarSpr8->setTextureRect(CCRectMake(0, 0, scale8, sliderBarSpr8->getContentSize().height));
        ...
        unlockInfo8->autorelease();
        auto unlock8 = SimplePlayer::create(1);
        unlock8->createSpiderSprite(1);
        auto lock8 = CCSprite::createWithSpriteFrameName("GJ_lockGray_001.png");

        auto sliderOutlineSpr9 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr9 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio9 = (float)(moons - std::stoi(unlockData18->numberString)) / (float)(std::stoi(unlockData19->numberString) - std::stoi(unlockData18->numberString));
        float scale9 = ratio9 >= 0.98f ? sliderBarSpr9->getContentSize().width * 0.98f : sliderBarSpr9->getContentSize().width * ratio9;
        sliderBarSpr9->setTextureRect(CCRectMake(0, 0, scale9, sliderBarSpr9->getContentSize().height));
        ...
        auto sliderOutlineSpr10 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr10 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio10 = (float)(moons - std::stoi(unlockData19->numberString)) / (float)(std::stoi(unlockData20->numberString) - std::stoi(unlockData19->numberString));
        float scale10 = ratio10 >= 0.98f ? sliderBarSpr10->getContentSize().width * 0.98f : sliderBarSpr10->getContentSize().width * ratio10;
        sliderBarSpr10->setTextureRect(CCRectMake(0, 0, scale10, sliderBarSpr10->getContentSize().height));
        ...
        /* Set Progress Text */
        bool isInTier =  moons >= std::stoi(unlockData10->numberString) && moons < std::stoi(unlockData20->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(moons).c_str()));
            currentProgressText->setPosition({-185, 138});
            tierContainer->addChild(currentProgressText);
    ...
    CCNode* createTier3(int moons) {
        ...
        auto sliderOutlineSpr1 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr1 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio1 = (float)(moons - std::stoi(unlockData20->numberString)) / (float)(std::stoi(unlockData21->numberString) - std::stoi(unlockData20->numberString));
        float scale1 = ratio1 >= 0.98f ? sliderBarSpr1->getContentSize().width * 0.98f : sliderBarSpr1->getContentSize().width * ratio1;
        sliderBarSpr1->setTextureRect(CCRectMake(0, 0, scale1, sliderBarSpr1->getContentSize().height));
        ...
        auto sliderOutlineSpr2 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr2 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio2 = (float)(moons - std::stoi(unlockData21->numberString)) / (float)(std::stoi(unlockData22->numberString) - std::stoi(unlockData21->numberString));
        float scale2 = ratio2 >= 0.98f ? sliderBarSpr2->getContentSize().width * 0.98f : sliderBarSpr2->getContentSize().width * ratio2;
        sliderBarSpr2->setTextureRect(CCRectMake(0, 0, scale2, sliderBarSpr2->getContentSize().height)); 
        ...
        auto sliderOutlineSpr3 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr3 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio3 = (float)(moons - std::stoi(unlockData22->numberString)) / (float)(std::stoi(unlockData23->numberString) - std::stoi(unlockData22->numberString));
        float scale3 = ratio3 >= 0.98f ? sliderBarSpr3->getContentSize().width * 0.98f : sliderBarSpr3->getContentSize().width * ratio3;
        sliderBarSpr3->setTextureRect(CCRectMake(0, 0, scale3, sliderBarSpr3->getContentSize().height));  
        ...
        auto sliderOutlineSpr4 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr4 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio4 = (float)(moons - std::stoi(unlockData23->numberString)) / (float)(std::stoi(unlockData24->numberString) - std::stoi(unlockData23->numberString));
        float scale4 = ratio4 >= 0.98f ? sliderBarSpr4->getContentSize().width * 0.98f : sliderBarSpr4->getContentSize().width * ratio4;
        sliderBarSpr4->setTextureRect(CCRectMake(0, 0, scale4, sliderBarSpr4->getContentSize().height));
        ...
        auto sliderOutlineSpr5 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr5 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio5 = (float)(moons - std::stoi(unlockData24->numberString)) / (float)(std::stoi(unlockData25->numberString) - std::stoi(unlockData24->numberString));
        float scale5 = ratio5 >= 0.98f ? sliderBarSpr5->getContentSize().width * 0.98f : sliderBarSpr5->getContentSize().width * ratio5;
        sliderBarSpr5->setTextureRect(CCRectMake(0, 0, scale5, sliderBarSpr5->getContentSize().height));
        ...
        auto sliderOutlineSpr6 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr6 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio6 = (float)(moons - std::stoi(unlockData25->numberString)) / (float)(std::stoi(unlockData26->numberString) - std::stoi(unlockData25->numberString));
        float scale6 = ratio6 >= 0.98f ? sliderBarSpr6->getContentSize().width * 0.98f : sliderBarSpr6->getContentSize().width * ratio6;
        sliderBarSpr6->setTextureRect(CCRectMake(0, 0, scale6, sliderBarSpr6->getContentSize().height));
        ...
        /* Set Progress Text */
        bool isInTier = moons >= std::stoi(unlockData20->numberString) && moons < std::stoi(unlockData26->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(moons).c_str()));
            currentProgressText->setPosition({-99, 138});
            tierContainer->addChild(currentProgressText);
