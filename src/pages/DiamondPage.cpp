...
class DiamondPage : public CCObject {
private:
...
public:
    DiamondPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("100", 31, "main"); unlockData1->autorelease();
        unlockData2 = new UnlockData("250", 87, IconType::Cube); unlockData2->autorelease();
        unlockData3 = new UnlockData("500", 11, IconType::Robot); unlockData3->autorelease();
        unlockData4 = new UnlockData("1000", 38, "main"); unlockData4->autorelease();
        unlockData5 = new UnlockData("1500", 19, IconType::Wave); unlockData5->autorelease();
        unlockData6 = new UnlockData("2000", 101, IconType::Cube); unlockData6->autorelease();
        unlockData7 = new UnlockData("2500", 32, IconType::Ship); unlockData7->autorelease();
        unlockData8 = new UnlockData("3000", 24, IconType::Ufo); unlockData8->autorelease();
        unlockData9 = new UnlockData("4000", 17, IconType::Wave); unlockData9->autorelease();
        unlockData10 = new UnlockData("5000", 10, IconType::DeathEffect); unlockData10->autorelease();

        unlockData11 = new UnlockData("6000", 159, IconType::Cube); unlockData11->autorelease();
        unlockData12 = new UnlockData("7000", 82, "main"); unlockData12->autorelease();
        unlockData13 = new UnlockData("9000", 319, IconType::Cube); unlockData13->autorelease();
        unlockData14 = new UnlockData("11000", 103, IconType::Ship); unlockData14->autorelease();
        unlockData15 = new UnlockData("14000", 52, "main"); unlockData15->autorelease();
        unlockData16 = new UnlockData("17000", 226, IconType::Cube); unlockData16->autorelease();
        unlockData17 = new UnlockData("20000", 52, IconType::Wave); unlockData17->autorelease();
        unlockData18 = new UnlockData("25000", 58, IconType::Robot); unlockData18->autorelease();
    }

    CCNode* createDiamondPage(int diamonds) {
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(DiamondPage::onTierButton)
        );
    ...
    CCNode* createTier1(int diamonds) {
        ...
        float ratio1 = (float)(diamonds - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(diamonds - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(diamonds - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(diamonds - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        auto unlockInfo4 = new UnlockInfo(unlockData4->unlockId, unlockData4->colorType);
        ...
        float ratio5 = (float)(diamonds - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(diamonds - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(diamonds - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        float ratio8 = (float)(diamonds - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        float ratio9 = (float)(diamonds - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(diamonds - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        auto unlock10 = GJItemIcon::createBrowserItem(gameManager->iconTypeToUnlockType(unlockInfo10->unlockType), unlockData10->unlockId);
        auto lock10 = CCSprite::createWithSpriteFrameName("GJ_lockGray_001.png");

        /* Set Progress Text */
        bool isInTier =  diamonds >= std::stoi(unlockData0->numberString) && diamonds < std::stoi(unlockData10->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(diamonds).c_str()));
        ...
        lock10->setPosition({15, 15}); lock10->setZOrder(1);
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(DiamondPage::openUnlockInfo)
		);
        ...
        unlockButton7->setPosition({-344.5f, -75});
    ...
    CCNode* createTier2(int diamonds) {
        auto tierContainer = CCNode::create();
        tierContainer->setPosition({0, 0});
        auto winSize = CCDirector::sharedDirector()->getWinSize();
        pageWidth = winSize.width * 0.75f;
        ...
        auto sliderOutlineSpr1 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr1 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        log::info("Current segment: {} - {}", diamonds, unlockData10->numberString);
        float ratio1 = (float)(diamonds - std::stoi(unlockData10->numberString)) / (float)(std::stoi(unlockData11->numberString) - std::stoi(unlockData10->numberString));
        log::info("Current ratio: {}", ratio1);
        float scale1 = ratio1 >= 0.98f ? sliderBarSpr1->getContentSize().width * 0.98f : sliderBarSpr1->getContentSize().width * ratio1;
        log::info("Current scale: {}", scale1);
        sliderBarSpr1->setTextureRect(CCRectMake(0, 0, scale1, sliderBarSpr1->getContentSize().height));
        ...
        auto sliderOutlineSpr2 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr2 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio2 = (float)(diamonds - std::stoi(unlockData11->numberString)) / (float)(std::stoi(unlockData12->numberString) - std::stoi(unlockData11->numberString));
        float scale2 = ratio2 >= 0.98f ? sliderBarSpr2->getContentSize().width * 0.98f : sliderBarSpr2->getContentSize().width * ratio2;
        sliderBarSpr2->setTextureRect(CCRectMake(0, 0, scale2, sliderBarSpr2->getContentSize().height)); 

        auto unlockText2 = CCLabelBMFont::create(addCommas(unlockData12->numberString.c_str()), "bigFont-uhd.fnt");
        auto unlockInfo2 = new UnlockInfo(unlockData12->unlockId, unlockData12->colorType);
        unlockInfo2->autorelease();
        ...
        auto sliderOutlineSpr3 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr3 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio3 = (float)(diamonds - std::stoi(unlockData12->numberString)) / (float)(std::stoi(unlockData13->numberString) - std::stoi(unlockData12->numberString));
        float scale3 = ratio3 >= 0.98f ? sliderBarSpr3->getContentSize().width * 0.98f : sliderBarSpr3->getContentSize().width * ratio3;
        sliderBarSpr3->setTextureRect(CCRectMake(0, 0, scale3, sliderBarSpr3->getContentSize().height));  
        ...
        auto sliderOutlineSpr4 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr4 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio4 = (float)(diamonds - std::stoi(unlockData13->numberString)) / (float)(std::stoi(unlockData14->numberString) - std::stoi(unlockData13->numberString));
        float scale4 = ratio4 >= 0.98f ? sliderBarSpr4->getContentSize().width * 0.98f : sliderBarSpr4->getContentSize().width * ratio4;
        sliderBarSpr4->setTextureRect(CCRectMake(0, 0, scale4, sliderBarSpr4->getContentSize().height));
        ...
        auto sliderOutlineSpr5 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr5 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio5 = (float)(diamonds - std::stoi(unlockData14->numberString)) / (float)(std::stoi(unlockData15->numberString) - std::stoi(unlockData14->numberString));
        float scale5 = ratio5 >= 0.98f ? sliderBarSpr5->getContentSize().width * 0.98f : sliderBarSpr5->getContentSize().width * ratio5;
        sliderBarSpr5->setTextureRect(CCRectMake(0, 0, scale5, sliderBarSpr5->getContentSize().height));

        auto unlockText5 = CCLabelBMFont::create(addCommas(unlockData15->numberString.c_str()), "bigFont-uhd.fnt");
        auto unlockInfo5 = new UnlockInfo(unlockData15->unlockId, unlockData15->colorType);
        unlockInfo5->autorelease();
        ...
        auto sliderOutlineSpr6 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr6 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio6 = (float)(diamonds - std::stoi(unlockData15->numberString)) / (float)(std::stoi(unlockData16->numberString) - std::stoi(unlockData15->numberString));
        float scale6 = ratio6 >= 0.98f ? sliderBarSpr6->getContentSize().width * 0.98f : sliderBarSpr6->getContentSize().width * ratio6;
        sliderBarSpr6->setTextureRect(CCRectMake(0, 0, scale6, sliderBarSpr6->getContentSize().height));
        ...
        auto sliderOutlineSpr7 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr7 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio7 = (float)(diamonds - std::stoi(unlockData16->numberString)) / (float)(std::stoi(unlockData17->numberString) - std::stoi(unlockData16->numberString));
        float scale7 = ratio7 >= 0.98f ? sliderBarSpr7->getContentSize().width * 0.98f : sliderBarSpr7->getContentSize().width * ratio7;
        sliderBarSpr7->setTextureRect(CCRectMake(0, 0, scale7, sliderBarSpr7->getContentSize().height));
        ...
        auto sliderOutlineSpr8 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr8 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio8 = (float)(diamonds - std::stoi(unlockData17->numberString)) / (float)(std::stoi(unlockData18->numberString) - std::stoi(unlockData17->numberString));
        float scale8 = ratio8 >= 0.98f ? sliderBarSpr8->getContentSize().width * 0.98f : sliderBarSpr8->getContentSize().width * ratio8;
        sliderBarSpr8->setTextureRect(CCRectMake(0, 0, scale8, sliderBarSpr8->getContentSize().height));
        ...
        unlockInfo8->autorelease();
        auto unlock8 = SimplePlayer::create(1);
        unlock8->createRobotSprite(1);
        auto lock8 = CCSprite::createWithSpriteFrameName("GJ_lockGray_001.png");

        /* Set Progress Text */
        bool isInTier =  diamonds >= std::stoi(unlockData10->numberString) && diamonds < std::stoi(unlockData18->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(diamonds).c_str()));
            currentProgressText->setPosition({-185, 138});
            tierContainer->addChild(currentProgressText);
