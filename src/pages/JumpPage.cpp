...
class JumpPage : public CCObject {
private:
...
public:
    JumpPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1000", 5, "secondary"); unlockData1->autorelease();
        unlockData2 = new UnlockData("10000", 11, "secondary"); unlockData2->autorelease();
        unlockData3 = new UnlockData("20000", 12, "secondary"); unlockData3->autorelease();
        unlockData4 = new UnlockData("50000", 5, IconType::Ufo); unlockData4->autorelease();
        unlockData5 = new UnlockData("100000", 13, IconType::Ball); unlockData5->autorelease();
        unlockData6 = new UnlockData("200000", 56, "main"); unlockData6->autorelease();
        unlockData7 = new UnlockData("300000", 371, IconType::Cube); unlockData7->autorelease();
        unlockData8 = new UnlockData("400000", 93, IconType::Wave); unlockData8->autorelease();
        unlockData9 = new UnlockData("500000", 365, IconType::Cube); unlockData9->autorelease();
        unlockData10 = new UnlockData("750000", 45, IconType::Wave); unlockData10->autorelease();

        unlockData11 = new UnlockData("1000000", 32, IconType::Swing); unlockData11->autorelease();
    }

    CCNode* createJumpPage(int jumps) {
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(JumpPage::onTierButton)
        );
    ...
    CCNode* createTier1(int jumps) {
        ...
        float ratio1 = (float)(jumps - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(jumps - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(jumps - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(jumps - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(jumps - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(jumps - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(jumps - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        float ratio8 = (float)(jumps - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  jumps >= std::stoi(unlockData0->numberString) && jumps < std::stoi(unlockData8->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(jumps).c_str()));
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(JumpPage::openUnlockInfo)
		);
    ...
    CCNode* createTier2(int jumps) {
        ...
        float ratio9 = (float)(jumps - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(jumps - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        auto sliderOutlineSpr1 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr1 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio1 = (float)(jumps - std::stoi(unlockData10->numberString)) / (float)(std::stoi(unlockData11->numberString) - std::stoi(unlockData10->numberString));
        float scale1 = ratio1 >= 0.98f ? sliderBarSpr1->getContentSize().width * 0.98f : sliderBarSpr1->getContentSize().width * ratio1;
        sliderBarSpr1->setTextureRect(CCRectMake(0, 0, scale1, sliderBarSpr1->getContentSize().height));
        ...
        /* Set Progress Text */
        bool isInTier =  jumps >= std::stoi(unlockData9->numberString) && jumps < std::stoi(unlockData11->numberString);
        if (ratio9 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(jumps).c_str()));
        ...
        /* First Row */
        unlockButton9->setPosition({-297.5f, -10});
        unlockButton10->setPosition({-208.5f, -10});
        unlockButton1->setPosition({-252, -75});
