...
class FriendPage : public CCObject {
private:
    ...
    ColorChannelSprite* unlock1;
    ColorChannelSprite* unlock2;
...
public:
    FriendPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1", 26, "secondary");
        unlockData2 = new UnlockData("10", 27, "main");
        unlockData3 = new UnlockData("25", 296, IconType::Cube);
        unlockData4 = new UnlockData("50", 272, IconType::Cube);

        starsAdd = false;
    }

    CCNode* createFriendPage(int friends) {
    ...
    void updateFriendCount(int friends) {
        ...
        float ratio1 = (float)(friends - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(friends - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(friends - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(friends - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        bool isInTier =  friends >= std::stoi(unlockData0->numberString) && friends < std::stoi(unlockData4->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(friends).c_str()));
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(FriendPage::onTierButton)
        );
    ...
    CCNode* createTier1(int friends) {
        ...
        unlockInfo1 = new UnlockInfo(unlockData1->unlockId, unlockData1->colorType);
        unlockInfo1->autorelease();
        unlock1 = ColorChannelSprite::create();
        ...
        unlockInfo2 = new UnlockInfo(unlockData2->unlockId, unlockData2->colorType);
        unlockInfo2->autorelease();
        unlock2 = ColorChannelSprite::create();
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(FriendPage::openUnlockInfo)
		);
