...
class RateStarsOfLevelsPage : public CCObject {
private:
...
public:
    RateStarsOfLevelsPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1", 9, "secondary"); unlockData1->autorelease();
        unlockData2 = new UnlockData("100", 22, "secondary"); unlockData2->autorelease();
        unlockData3 = new UnlockData("500", 5, IconType::Wave); unlockData3->autorelease();
        unlockData4 = new UnlockData("1000", 23, "main"); unlockData4->autorelease();
        unlockData5 = new UnlockData("2000", 57, IconType::Cube); unlockData5->autorelease();
    }

    CCNode* createRateStarsOfLevelPage(int rateStarsOfLevels) {
        ...
        auto labelSpr = CCSprite::create("rate_stars_spr.png"_spr);
        ...
        auto labelTopSpr = CCSprite::create("rate_stars_top_spr.png"_spr);
        labelTopSpr->setPosition({228.25f, 175});
        labelTopSpr->setScale(0.5f);
        pageContainer->addChild(labelTopSpr);

        tier1Page = createTier1(rateStarsOfLevels);
        tier1Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(RateStarsOfLevelsPage::onTierButton)
        );
    ...
    CCNode* createTier1(int rateStarsOfLevels) {
        ...
        float ratio1 = (float)(rateStarsOfLevels - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(rateStarsOfLevels - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(rateStarsOfLevels - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(rateStarsOfLevels - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(rateStarsOfLevels - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  rateStarsOfLevels >= std::stoi(unlockData0->numberString) && rateStarsOfLevels < std::stoi(unlockData5->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(rateStarsOfLevels).c_str()));
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(RateStarsOfLevelsPage::openUnlockInfo)
		);
