...
class AttemptPage : public CCObject {
private:
...
public:
    AttemptPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("100", 6, "secondary"); unlockData1->autorelease();
        unlockData2 = new UnlockData("500", 7, "secondary"); unlockData2->autorelease();
        unlockData3 = new UnlockData("2000", 14, "secondary"); unlockData3->autorelease();
        unlockData4 = new UnlockData("10000", 17, "secondary"); unlockData4->autorelease();
        unlockData5 = new UnlockData("20000", 3, IconType::Wave); unlockData5->autorelease();
        unlockData6 = new UnlockData("30000", 341, IconType::Cube); unlockData6->autorelease();
        unlockData7 = new UnlockData("40000", 96, "main"); unlockData7->autorelease();
        unlockData8 = new UnlockData("60000", 161, IconType::Ship); unlockData8->autorelease();
        unlockData9 = new UnlockData("80000", 407, IconType::Cube); unlockData9->autorelease();
        unlockData10 = new UnlockData("100000", 9, IconType::Swing); unlockData10->autorelease();

        unlockData11 = new UnlockData("135000", 117, IconType::Ball); unlockData11->autorelease();
        unlockData12 = new UnlockData("185000", 46, IconType::Ball); unlockData12->autorelease();
        unlockData13 = new UnlockData("250000", 65, IconType::Ship); unlockData13->autorelease();
        unlockData14 = new UnlockData("300000", 368, IconType::Cube); unlockData14->autorelease();
    }

    CCNode* createAttemptPage(int attempts) {
        ...
        tier2Page = createTier2(attempts);
        tier2Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(AttemptPage::onTierButton)
        );
    ...
    CCNode* createTier1(int attempts) {
        ...
        float ratio1 = (float)(attempts - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(attempts - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(attempts - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(attempts - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(attempts - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(attempts - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(attempts - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        float ratio8 = (float)(attempts - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        float ratio9 = (float)(attempts - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(attempts - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  attempts >= std::stoi(unlockData0->numberString) && attempts < std::stoi(unlockData10->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(attempts).c_str()));
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(AttemptPage::openUnlockInfo)
		);
    ...
    CCNode* createTier2(int attempts) {
        auto tierContainer = CCNode::create();
        tierContainer->setPosition({0, 0});
        auto winSize = CCDirector::sharedDirector()->getWinSize();
        pageWidth = winSize.width * 0.75f;
        ...
        auto sliderOutlineSpr1 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr1 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio1 = (float)(attempts - std::stoi(unlockData10->numberString)) / (float)(std::stoi(unlockData11->numberString) - std::stoi(unlockData10->numberString));
        float scale1 = ratio1 >= 0.98f ? sliderBarSpr1->getContentSize().width * 0.98f : sliderBarSpr1->getContentSize().width * ratio1;
        sliderBarSpr1->setTextureRect(CCRectMake(0, 0, scale1, sliderBarSpr1->getContentSize().height));
        ...
        auto sliderOutlineSpr2 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr2 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio2 = (float)(attempts - std::stoi(unlockData11->numberString)) / (float)(std::stoi(unlockData12->numberString) - std::stoi(unlockData11->numberString));
        float scale2 = ratio2 >= 0.98f ? sliderBarSpr2->getContentSize().width * 0.98f : sliderBarSpr2->getContentSize().width * ratio2;
        sliderBarSpr2->setTextureRect(CCRectMake(0, 0, scale2, sliderBarSpr2->getContentSize().height)); 
        ...
        auto sliderOutlineSpr3 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr3 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio3 = (float)(attempts - std::stoi(unlockData12->numberString)) / (float)(std::stoi(unlockData13->numberString) - std::stoi(unlockData12->numberString));
        float scale3 = ratio3 >= 0.98f ? sliderBarSpr3->getContentSize().width * 0.98f : sliderBarSpr3->getContentSize().width * ratio3;
        sliderBarSpr3->setTextureRect(CCRectMake(0, 0, scale3, sliderBarSpr3->getContentSize().height));  
        ...
        auto sliderOutlineSpr4 = CCSprite::create("Progress_Outline.png"_spr);
        auto sliderBarSpr4 = togglePlayerColours ? CCSprite::create("sliderBar2-uhd.png") : CCSprite::create("sliderBar-uhd.png");
        float ratio4 = (float)(attempts - std::stoi(unlockData13->numberString)) / (float)(std::stoi(unlockData14->numberString) - std::stoi(unlockData13->numberString));
        float scale4 = ratio4 >= 0.98f ? sliderBarSpr4->getContentSize().width * 0.98f : sliderBarSpr4->getContentSize().width * ratio4;
        sliderBarSpr4->setTextureRect(CCRectMake(0, 0, scale4, sliderBarSpr4->getContentSize().height));
        ...
        /* Set Progress Text */
        bool isInTier =  attempts >= std::stoi(unlockData10->numberString) && attempts < std::stoi(unlockData14->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(attempts).c_str()));
            currentProgressText->setPosition({-99, 138});
            tierContainer->addChild(currentProgressText);
