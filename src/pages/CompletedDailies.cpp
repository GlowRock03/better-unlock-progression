...
class CompletedDailies : public CCObject {
private:
...
public:
    CompletedDailies(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1", 267, IconType::Cube); unlockData1->autorelease();
        unlockData2 = new UnlockData("25", 22, IconType::Swing); unlockData2->autorelease();
        unlockData3 = new UnlockData("50", 58, "main"); unlockData3->autorelease();
        unlockData4 = new UnlockData("100", 403, IconType::Cube); unlockData4->autorelease();
        unlockData5 = new UnlockData("150", 43, IconType::Spider); unlockData5->autorelease();
        unlockData6 = new UnlockData("250", 91, IconType::Ufo); unlockData6->autorelease();
        unlockData7 = new UnlockData("365", 396, IconType::Cube); unlockData7->autorelease();
    }

    CCNode* createCompletedDailiesPage(int completedDailies) {
        ...
        auto labelSpr = CCSprite::create("completed_daily_spr.png"_spr);
        ...
        auto labelTopSpr = CCSprite::create("completed_daily_top_spr.png"_spr);
        labelTopSpr->setPosition({228.25f, 180});
        labelTopSpr->setScale(0.3f);
        pageContainer->addChild(labelTopSpr);

        tier1Page = createTier1(completedDailies);
        tier1Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(CompletedDailies::onTierButton)
        );
    ...
    CCNode* createTier1(int completedDailies) {
        ...
        float ratio1 = (float)(completedDailies - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(completedDailies - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(completedDailies - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(completedDailies - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(completedDailies - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(completedDailies - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        auto unlockText6 = CCLabelBMFont::create(unlockData6->numberString.c_str(), "bigFont-uhd.fnt");
        ...
        float ratio7 = (float)(completedDailies - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        auto unlockText7 = CCLabelBMFont::create(unlockData7->numberString.c_str(), "bigFont-uhd.fnt");
        ...
        /* Set Progress Text */
        bool isInTier =  completedDailies >= std::stoi(unlockData0->numberString) && completedDailies < std::stoi(unlockData7->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(completedDailies).c_str()));
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(CompletedDailies::openUnlockInfo)
		);
