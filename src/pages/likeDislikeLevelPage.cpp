...
class LikeDislikeLevelPage : public CCObject {
private:
...
public:
    LikeDislikeLevelPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1", 8, "secondary"); unlockData1->autorelease();
        unlockData2 = new UnlockData("100", 23, "secondary"); unlockData2->autorelease();
        unlockData3 = new UnlockData("500", 26, "main"); unlockData3->autorelease();
        unlockData4 = new UnlockData("1000", 22, "main"); unlockData4->autorelease();
        unlockData5 = new UnlockData("2000", 3, IconType::Special); unlockData5->autorelease();
        unlockData6 = new UnlockData("3000", 271, IconType::Cube); unlockData6->autorelease();
        unlockData7 = new UnlockData("4000", 70, IconType::Ball); unlockData7->autorelease();
    }

    CCNode* createLikeDislikeLevelPage(int likeDislikeLevels) {
        ...
        auto labelSpr = CCSprite::create("like_dislike_spr.png"_spr);
        ...
        auto labelTopSpr = CCSprite::create("like_dislike_top_spr.png"_spr);
        labelTopSpr->setPosition({228.25f, 175});
        labelTopSpr->setScale(0.5f);
        pageContainer->addChild(labelTopSpr);

        tier1Page = createTier1(likeDislikeLevels);
        tier1Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(LikeDislikeLevelPage::onTierButton)
        );
    ...
    CCNode* createTier1(int likeDislikeLevels) {
        ...
        float ratio1 = (float)(likeDislikeLevels - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(likeDislikeLevels - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(likeDislikeLevels - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(likeDislikeLevels - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(likeDislikeLevels - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        auto unlock5 = GJItemIcon::createBrowserItem(gameManager->iconTypeToUnlockType(unlockInfo5->unlockType), unlockData5->unlockId);
        ...
        float ratio6 = (float)(likeDislikeLevels - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(likeDislikeLevels - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  likeDislikeLevels >= std::stoi(unlockData0->numberString) && likeDislikeLevels < std::stoi(unlockData7->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(likeDislikeLevels).c_str()));
        ...
        lock5->setPosition({15, 15}); lock5->setZOrder(1);
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(LikeDislikeLevelPage::openUnlockInfo)
		);
