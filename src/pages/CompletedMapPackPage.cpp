...
class CompletedMapPackPage : public CCObject {
private:
...
public:
    CompletedMapPackPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("1", 33, IconType::Cube); unlockData1->autorelease();
        unlockData2 = new UnlockData("5", 10, IconType::Ship); unlockData2->autorelease();
        unlockData3 = new UnlockData("10", 2, IconType::Special); unlockData3->autorelease();
        unlockData4 = new UnlockData("15", 11, IconType::Ship); unlockData4->autorelease();
        unlockData5 = new UnlockData("20", 7, IconType::Ball); unlockData5->autorelease();
        unlockData6 = new UnlockData("25", 8, IconType::Ball); unlockData6->autorelease();
        unlockData7 = new UnlockData("30", 10, IconType::Ufo); unlockData7->autorelease();
        unlockData8 = new UnlockData("35", 58, IconType::Cube); unlockData8->autorelease();
        unlockData9 = new UnlockData("40", 15, IconType::Ball); unlockData9->autorelease();
        unlockData10 = new UnlockData("45", 11, IconType::Wave); unlockData10->autorelease();
    }

    CCNode* createCompletedMapPackPage(int completedMapPacks) {
        ...
        auto labelSpr = CCSprite::create("completed_map_packs_spr.png"_spr);
        ...
        auto labelTopSpr = CCSprite::create("completed_map_packs_top_spr.png"_spr);
        labelTopSpr->setPosition({228.25f, 175});
        labelTopSpr->setScale(0.5f);
        pageContainer->addChild(labelTopSpr);

        tier1Page = createTier1(completedMapPacks);
        tier1Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(CompletedMapPackPage::onTierButton)
        );
    ...
    CCNode* createTier1(int completedMapPacks) {
        ...
        float ratio1 = (float)(completedMapPacks - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(completedMapPacks - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(completedMapPacks - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        auto unlock3 = GJItemIcon::createBrowserItem(gameManager->iconTypeToUnlockType(unlockInfo3->unlockType), unlockData3->unlockId);
        ...
        float ratio4 = (float)(completedMapPacks - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(completedMapPacks - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(completedMapPacks - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(completedMapPacks - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        float ratio8 = (float)(completedMapPacks - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        float ratio9 = (float)(completedMapPacks - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(completedMapPacks - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  completedMapPacks >= std::stoi(unlockData0->numberString) && completedMapPacks < std::stoi(unlockData10->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(completedMapPacks).c_str()));
        ...
        lock3->setPosition({15, 15}); lock3->setZOrder(1);
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(CompletedMapPackPage::openUnlockInfo)
		);
