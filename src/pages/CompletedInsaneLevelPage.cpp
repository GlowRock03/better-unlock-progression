...
class CompletedInsaneLevelPage : public CCObject {
private:
...
public:
    CompletedInsaneLevelPage(FLAlertLayer* parentPopup) {
        ...
        unlockData1 = new UnlockData("5", 201, IconType::Cube); unlockData1->autorelease();
        unlockData2 = new UnlockData("10", 266, IconType::Cube); unlockData2->autorelease();
        unlockData3 = new UnlockData("25", 50, IconType::Ball); unlockData3->autorelease();
        unlockData4 = new UnlockData("50", 174, IconType::Cube); unlockData4->autorelease();
        unlockData5 = new UnlockData("75", 86, IconType::Wave); unlockData5->autorelease();
        unlockData6 = new UnlockData("100", 277, IconType::Cube); unlockData6->autorelease();
        unlockData7 = new UnlockData("200", 119, IconType::Ship); unlockData7->autorelease();
        unlockData8 = new UnlockData("300", 481, IconType::Cube); unlockData8->autorelease();
        unlockData9 = new UnlockData("400", 37, IconType::Spider); unlockData9->autorelease();
        unlockData10 = new UnlockData("500", 64, IconType::Ufo); unlockData10->autorelease();
    }

    CCNode* createInsaneLevelPage(int completedInsanes) {
        ...
        auto labelSpr = CCSprite::create("completed_insanes_spr.png"_spr);
        ...
        auto labelTopSpr = CCSprite::create("completed_insanes_top_spr.png"_spr);
        labelTopSpr->setPosition({228.25f, 175});
        labelTopSpr->setScale(0.5f);
        pageContainer->addChild(labelTopSpr);

        tier1Page = createTier1(completedInsanes);
        tier1Page->retain();
...
private:
    void createNavigationButtons() {
        ...
        auto tier1Button = CCMenuItemSpriteExtra::create(
            tier1ButtonSpr,
            this,
            menu_selector(CompletedInsaneLevelPage::onTierButton)
        );
    ...
    CCNode* createTier1(int completedInsanes) {
        ...
        float ratio1 = (float)(completedInsanes - std::stoi(unlockData0->numberString)) / (float)(std::stoi(unlockData1->numberString) - std::stoi(unlockData0->numberString));
        ...
        float ratio2 = (float)(completedInsanes - std::stoi(unlockData1->numberString)) / (float)(std::stoi(unlockData2->numberString) - std::stoi(unlockData1->numberString));
        ...
        float ratio3 = (float)(completedInsanes - std::stoi(unlockData2->numberString)) / (float)(std::stoi(unlockData3->numberString) - std::stoi(unlockData2->numberString));
        ...
        float ratio4 = (float)(completedInsanes - std::stoi(unlockData3->numberString)) / (float)(std::stoi(unlockData4->numberString) - std::stoi(unlockData3->numberString));
        ...
        float ratio5 = (float)(completedInsanes - std::stoi(unlockData4->numberString)) / (float)(std::stoi(unlockData5->numberString) - std::stoi(unlockData4->numberString));
        ...
        float ratio6 = (float)(completedInsanes - std::stoi(unlockData5->numberString)) / (float)(std::stoi(unlockData6->numberString) - std::stoi(unlockData5->numberString));
        ...
        float ratio7 = (float)(completedInsanes - std::stoi(unlockData6->numberString)) / (float)(std::stoi(unlockData7->numberString) - std::stoi(unlockData6->numberString));
        ...
        float ratio8 = (float)(completedInsanes - std::stoi(unlockData7->numberString)) / (float)(std::stoi(unlockData8->numberString) - std::stoi(unlockData7->numberString));
        ...
        float ratio9 = (float)(completedInsanes - std::stoi(unlockData8->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        float ratio10 = (float)(completedInsanes - std::stoi(unlockData9->numberString)) / (float)(std::stoi(unlockData9->numberString) - std::stoi(unlockData8->numberString));
        ...
        /* Set Progress Text */
        bool isInTier =  completedInsanes >= std::stoi(unlockData0->numberString) && completedInsanes < std::stoi(unlockData10->numberString);
        if (ratio1 < 1.f && isInTier) {
            currentProgressText->setString(addCommas(std::to_string(completedInsanes).c_str()));
        ...
        auto unlockButton1 = CCMenuItemSpriteExtra::create(
			unlock1,
			this,
			menu_selector(CompletedInsaneLevelPage::openUnlockInfo)
		);
